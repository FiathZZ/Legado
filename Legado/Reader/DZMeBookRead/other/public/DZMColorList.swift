...
/// Retained for source compatibility with DZMeBookRead. Legado intentionally uses a
/// flat colour here; reading backgrounds must not load the upstream paper-texture asset.
let DZM_COLOR_BG_0:UIColor = ReaderThemePreset.paper.uiBackgroundColor
